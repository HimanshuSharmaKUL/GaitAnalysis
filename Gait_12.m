%KNN Classification code to authenticate a person (FOR GII-EF)
...
for e=1:124
    count=count+1;
    initialFname_tr=strcat('F:\','GaitDatasetB\','DatasetB\','silhouettes_matlab\','GII-EF_train\');
    
       pngFilename_tr=sprintf('nm-01-90-gii-ef-%d.png', e);
...
for f=1:124
    count2=count2+1;
    initialFname_te=strcat('F:\','GaitDatasetB\','DatasetB\','silhouettes_matlab\','GII-EF_test\');
    pngFilename_te=sprintf('gii-ef-%d.png',f); %change if req (cir)
